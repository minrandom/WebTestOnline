    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header flex flex-col gap-1 px-5 mt-5">
                ...
                <p class="text-[#7F8190]">Update The Course</p>
            </div>
            ...
            @method('PUT')
                ...
                <div class="group/category flex flex-col gap-[10px]">
                    ...
                    <div class="peer flex items-center p-[12px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <select id="category" class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('assets/images/icons/arrow-down.svg')] bg-no-repeat bg-right" name="category_id" required>
